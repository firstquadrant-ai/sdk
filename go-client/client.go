...
// APIClient manages communication with the FirstQuadrant API API v0.0.0
...
type APIClient struct {
	...
	IncomingWebhooksApi *IncomingWebhooksApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.IncomingWebhooksApi = (*IncomingWebhooksApiService)(&c.common)
