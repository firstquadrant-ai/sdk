...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    mark_conversation_as_won_body = MarkConversationAsWonBody(None) # MarkConversationAsWonBody | Find conversations using the given email address and create unique goal events based on the idempotency key.

    try:
        # Mark conversations as won
        api_response = api_instance.incoming_webhooks_mark_conversations_as_won_post(mark_conversation_as_won_body)
        pprint(api_response)
...
------------ | ------------- | ------------- | -------------
*IncomingWebhooksApi* | [**incoming_webhooks_mark_conversations_as_won_post**](docs/apis/tags/IncomingWebhooksApi.md#incoming_webhooks_mark_conversations_as_won_post) | **post** /incoming-webhooks/mark-conversations-as-won | Mark conversations as won
*TeamsApi* | [**teams_me_get**](docs/apis/tags/TeamsApi.md#teams_me_get) | **get** /teams/me | Get team

## Documentation For Models

 - [MarkConversationAsWonBody](docs/models/MarkConversationAsWonBody.md)
